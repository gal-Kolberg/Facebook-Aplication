...
{
    public partial class PictureToAsciiSettingsForm : Form
    {
        ...
        private int GivenImageHight { get; set; }

        private int GivenImageWidth { get; set; }
        ...
        public PictureToAsciiSettingsForm()
        {
            InitializeComponent();
        }

        public void InitForm(int i_ImageHight, int i_ImageWidth)
        {
            ...
            NumOfCharsComboBox.Items.Clear();
        ...
        {
            WhiteToBlackRadioButton.Enabled = true;
            BlackToWhiteRadioButton.Enabled = true;
        }

        public void LimitToBusinessUser()
        {
            WhiteToBlackRadioButton.Enabled = false;
            BlackToWhiteRadioButton.Enabled = false;
        }
